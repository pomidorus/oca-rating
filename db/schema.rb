...
ActiveRecord::Schema.define(version: 20150501112947) do
  ...
  create_table "ux_testers", force: true do |t|
    t.string   "name"
  ...
  add_index "ux_testers", ["access_code"], name: "index_ux_testers_on_access_code", using: :btree
